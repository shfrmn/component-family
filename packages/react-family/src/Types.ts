 ...
 */
export type FamilyComponent<Conf extends AnyFamilyConfig> = ComponentType<
  FamilyProps<Conf>
>
...
> = ComponentType<VariantProps<Conf, Conf[variant]>>
